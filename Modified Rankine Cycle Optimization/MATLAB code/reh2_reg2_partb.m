...
for i = 1:length(Pb_range)
    for j = 1:length(Pc_range)
        ...
        [efficiency, Wnet] = calculate_cycle_performance(P3, P8);
...
contourf(Pc_range, Pb_range, Wnet_results', 30, 'LineColor', 'none');
colorbar;
xlabel('Condenser Pressure (Pa)');
ylabel('Boiler Pressure (Pa)');
...
function [efficiency, Wnet] = calculate_cycle_performance(P3, P8)
